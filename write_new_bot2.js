...
const bak = TARGET.replace('.js', `.v9bak_${Date.now()}.js`);
...
const newContent = `/**
 * tg_status_bot.js v10
 * 어드민 신규주문(spnNew5) + 곳간 상품 파싱 수정
 */
...
async function getAdminOrders() {
  ...
  try {
    ...
    orderCount = parseInt(stats.spnNew5) || 0;  // 신규주문(주문접수)
...
async function getGotganOrders() {
  ...
  try {
    ...
    // ★ 상품 파싱: 셀[5] "상품명 / N 개 · 옵션..." — 정규식으로 슬래시 공백 유연하게
...
console.log('✅ tg_status_bot.js v10 작성 완료!');
console.log('\n실행:');
